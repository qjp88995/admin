...
use app\model\CollectionCate as CCT;

class Collectioncate extends Auth{
    ...
    public function detail(){
        ...
        $data = CCT::find(request()->param('_id'));
        return json($data);
    }
    public function insert(){
        ...
        if(!empty($data['parent'])){
            $category = $CCT->field('title')->find($data['parent']['id']['$oid']);
            $data['parent'] = [
