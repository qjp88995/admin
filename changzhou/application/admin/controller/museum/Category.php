...
class Category extends Common{
    ...
    public function insert(){
        ...
        if(!empty($data['parent'])){
            $category = $MuseumCategory->field('title,name')->find($data['parent']['id']);
            $data['parent'] = [
                'id' => $data['parent']['id'],
        ...
        $data['createAt'] = time();
        $data['updateAt'] = time();
        $result = $MuseumCategory->insert($data);
        if ($result) {
    ...
    public function update(){
        ...
        $data['updateAt'] = time();
        $result = $MuseumCategory->update($data);
        if ($result) {
    ...
    public function delete(){
        ...
        $result = MuseumCategory::destroy($_id);
        if ($result) {
            return json([
                'code' => true,
                'msg'  => '删除成功！'
